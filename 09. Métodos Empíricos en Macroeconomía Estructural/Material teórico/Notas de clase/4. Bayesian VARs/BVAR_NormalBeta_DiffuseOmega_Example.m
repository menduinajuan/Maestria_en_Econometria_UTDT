...
% WISHART PARAMETERS AND STUFF FOR DIFFUSE PRIOR
degrees_freedom = T;
XXpXXm1 = inv(XX'*XX);
...
for irep = 1:ndraws_total
    ...
    OMEGA = inv( wish(inv(SSE_Gibbs),degrees_freedom) ); % Draw OMEGA CONDITIONAL ON BETA 
...
tightfig;
print(gcf,'Figure_us_NormalBeta_DiffuseOmega_Priors_IR_inflation','-dpdf');
...
tightfig;
print(gcf,'Figure_us_NormalBeta_DiffuseOmega_Priors_IR_unemployment','-dpdf');
...
tightfig;
print(gcf,'Figure_us_NormalBeta_DiffuseOmega_Priors_IR_irate','-dpdf');
