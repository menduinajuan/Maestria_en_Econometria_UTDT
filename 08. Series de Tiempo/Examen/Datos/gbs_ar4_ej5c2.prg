...
dlog(m_t) - dlog(p_t) = alpha_0 + alpha_1 * d(i_t) + alpha_2 * dlog(y_t) + e_t
...
dif_dlog_m_p = data[2:213,4];
d_i = data[2:213,10];
dlog_y = data[2:213,7];

@ Para la submuestra (1962q1-1979q3) @
/*
dif_dlog_m_p = data[2:72,4];
d_i = data[2:72,10];
dlog_y = data[2:72,7];
*/
...
/*
dif_dlog_m_p = data[85:213,4];
d_i = data[85:213,10];
dlog_y = data[85:213,7];
*/
